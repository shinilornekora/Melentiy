module.exports = function getIndexPageScript(description, dependencies, structure) {
    return `
        ...
        **Important Rules**:
        ...
        5. YOU ALWAYS HAVE ACCESS ONLY TO \`style.css\` STYLES FILE. Do NOT add any other of them in html code.
